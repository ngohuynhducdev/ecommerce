  ...
  return (
    <aside className="sticky top-28">
      ...
      <div className="flex flex-col items-center text-center pb-4">
        <div className="w-14 h-14 rounded-full bg-subtle flex items-center justify-center font-semibold text-lg text-primary select-none">
          {getInitials(name)}
        </div>
        <p className="font-medium mt-2 text-primary">{name ?? "User"}</p>
