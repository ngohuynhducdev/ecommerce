...
export function BottomNav() {
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 h-16 bg-white border-t border-border grid grid-cols-4">
        ...
        const content = (
          <>
            <div className="relative inline-flex">
              {icon(isActive)}
              {badgeCount > 0 && (
                <span className="absolute -top-1.5 -right-1.5 w-4 h-4 bg-primary text-white text-[10px] rounded-full flex items-center justify-center leading-none">
