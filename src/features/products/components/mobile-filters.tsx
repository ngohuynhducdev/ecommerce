  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger asChild>
        <button className="lg:hidden flex items-center gap-2 border border-border px-4 py-2 rounded-sm text-sm text-primary hover:border-primary transition-colors cursor-pointer">
