  ...
  return (
    <div className="flex items-center gap-3 mt-10 pt-8 border-t border-border">
      ...
      <button
        ...
        className="w-9 h-9 flex items-center justify-center border border-border rounded-full text-muted hover:border-primary hover:text-primary transition-colors"
